<template>
  <div class="d-flex row" style="height: 100vh; width: 100vw; margin: 0px;">
    <div class="col-7">
      ...
      <a class="social_btn" href="https://pairplay.site/oauth2/authorization/google?redirect_uri=http://pairplay.site:80/oauth/redirect">
      ...
      <a class="social_btn" href="https://pairplay.site/oauth2/authorization/kakao?redirect_uri=http://pairplay.site:80/oauth/redirect">
