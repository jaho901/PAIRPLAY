          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu mt-2" aria-labelledby="dropdownMenuButton" style="height: 60vh">
              <li class="sido">
                ...
                <ul v-if="state.sido" class="dropdown-menu dropdown-submenu px-2 text-align" @click="selectBusanGugun" style="width: 30vw; height: 60vh">
                  <li v-for="(gungu, index) in state.gunguList[state.sido]" :key="index" class="d-flex my-2">
                    <input v-for="(gu, ix) in gungu" :key="ix" type="button" class="dropdown-item ps-4" style="width: 25%" :value="gu" @click="changeGungu($event)" />
                  </li>
