<template>
  <div>
    ...
    <div class="d-flex row" style="width: 100%">
      <div v-for="(card, i) in state.cards" :key="i" class="col-3 mt-4 mb-5">
        <!-- {{ card }} -->
        <a class="card d-flex justify-content-between" style="flex-direction: column">
          <!-- Modal -->
          <div class="mx-4 mt-4" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" @click="changeMateDetail(card.activityId)">
          ...
          <div class="d-flex justify-content-between align-items-center bottom-divider">
            ...
            <div class="me-4" style="color: rgb(174 174 174); font-size: small">{{ card.timeDiff }}일 전 업데이트</div>
          </div>
          <!-- <label class="like">
            <input type="checkbox">
            <div class="hearth"/>
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  <div class="col-6">
                    ...
                    <div class="row mt-5">
                      <div class="col-1"></div>
                      <button class="col-3 btn btn-secondary mate-apply" @click="mateApplyFor(mateDetail.activityId)">신청하기</button>
                    </div>
                  </div>
