...
public interface ActivityRepository extends JpaRepository<Activity, Long> {
        ...
        @Query(value = " select a.id, a.created_date, a.modified_date, a.category_id, a.title, a.description, a.meet_dt, a.close_dt,  a.create_id, a.is_end, a.location, a.mate_image, a.age, a.gender " +
